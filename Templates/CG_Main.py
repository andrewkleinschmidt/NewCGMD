...
def main():
    ...
    Script, deg_polymerization, num_polymer, box_length, dispersity, substrate, Solv_Screen = sys.argv
    ...
    Position_M, Position_S1, Position_S2, Bases, zBoxLength  =  poly.Gen_Many_Polymers( deg_polymerization, num_polymer, Huang.BondLengths, Huang.Angles, Huang.SigmaM_M, box_length, dispersity, substrate)
